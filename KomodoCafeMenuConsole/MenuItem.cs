...
namespace KomodoCafeMenuConsole
{
    ...
    {//Just a POCO
        ...
        { // decimals since were dealing with money
            get
            {
                return this.Price;//always throws errors: decimal.Round(Price, 2, MidpointRounding.AwayFromZero); //always give back answers in 2 decimal places since were dealing with money
            }
